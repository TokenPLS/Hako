...
func TestCompileRefusalDoesNotEchoFileContent(t *testing.T) {
	...
	// Measured on the scanner itself now: the cheap refusal judgement it used to go through
	// had no production caller left once a refused set simply rides as source.
