...
//
// Both halves exist now. The threshold machine polls,
// holds the three-state hysteresis, and since the device evidence of 2026-08-25 (nineteen
// report-only triggers across three jetsam kills) its shed action is enabled by default,
// as upstream's is.
//
